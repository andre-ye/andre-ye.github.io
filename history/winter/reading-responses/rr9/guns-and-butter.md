...
### Introduction
- Opposiiton to full rights to suspect populations was common in social and criminal policy discourse.
...
- Makes a case for approaching the growth of the carceral system and welfare state retrenchment as an intertwined phenomena.
- The welfare and penal system have long coexisted and developed together.
- State transformations were driven more by struggles of how to direct state intervention, rather between who woudl expand.
  - Not asking if the state had a role in managing marginalized population, but instead which institutions of the state should empower the task.
...
- Examining welfare and penal transofrmations together helps to recast assumptions about the "rise of the Right".
  - These assumptions often assume conservatives aimed to decrease the governmnet's size and role in society.
- However, this obscures the roles of other groups - moderates and liberals - in facilitating state transformation.
- Neoliberalism theorists illustrate that the post-1970 economy was sculpted significnatly through state intervention and subsidy.
  - Tension between antistatist rhetoric and state-building actions.
- Conservatives of the 1980 did not consistently deliver on the promise to reduce government.
...
- Responsibility for handling social problems was transferred from welfare programs to law enforcement.
  - Penal system became dominant institution managing drug use in low-income communities.
- Transfer from treatment (pyschiatric hospitals and developmental centers of 1960-1980) to incarceration (prisons and jails).
...
- Earned Income Tax Credit - ameliorating the poverty of millions of families by subsidizing low wages via tax credit.
  - *Assimilative strategies* can also reify hierarchies by marking certain behaviors as deviant.
- Other programs have explciitly exclusionary aims.
  - Penal system diminishes civil personhood.
  - Citizenship is also denigrated postrelease via surveillnace, disenfranchisement, prohibitions.
...
- Rehabilitation of individuals was dominanht in the 1960s to 1970s; the penal system dedicated itself to "corrections" and reintegration that coexisted with exclusionary practices.
...
- "Urban crisis" - economic downturn, capital migration, discriminatory housing and hiring.
...
- Trade-off of "guns and butter" - diminished resources for social programs contrasted against escalating Vietnam War cost.
  ...
  - Socal welfare spending vs tough punishment and law enforcement.
...
- Opponents of Johnson's War on Poverty asserted that welfare programs targeting the undeserving poor were futile; such welfare programs actually created, rather than reduced, disorder.
...
- Emphasis on punishment also resulted in postrelease restrictions on citizenship.
...
- The binary of "big government vs small government" obscures the fact that certain groups consistently confront state intervension and compulsion.
